...
class TestGraphAlgo(TestCase):
    ...
    def test_shortest_path(self):
        graph_algo_test: GraphAlgo = GraphAlgo(g1)
    ...
    def test_center_point(self):
        ...
        self.assertEqual(6.8068, graph_algo_test2.centerPoint()[1], 0.001)
        graph_algo_test2.load_from_json("../data/A1.json")
        self.assertEqual(8, graph_algo_test2.centerPoint()[0])
        self.assertEqual(9.925289024973141, graph_algo_test2.centerPoint()[1])
